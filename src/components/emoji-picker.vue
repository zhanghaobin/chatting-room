<template>
    <section class="emoji-picker">
        <img v-for="(e, i) in this.emoji" :src="'/static/emoji/' + i + '.gif'" :alt="`(emoji:${i})`" draggable="false" @drag.prevent
             :class="prefix + i" @click="$emit('emoji-picked', $event)"/>
    </section>
</template>
...
<style scoped src="./../assets/styles/emoji-picker.css"></style>
